...
if (heroTitle) {
    ...
    // Keep the original text as is for now
}

// Add smooth reveal animation to hero content on page load
...
if (footerText) {
    footerText.textContent = `© ${currentYear} Amit Ranjan Maurya. All rights reserved.`;
}
